...
<head>
    <meta charset="utf-8">
    <meta name="author" content="Nekruz Nazirjonov">
    <title>Лаб 2</title>
...
<table id='main' width="100%">
    ...
    <tr>
        <td id="hat"><br>
            <p>Автор проекта:<img src="logo/NK%20Logo.jpg" alt="logo" height="30" ></p>
            <p>Назирджанов Некруз</p>
            <p>Группа: Р32111</p>
            <p>Вариант: 1119</p>
            ...
            <p>
            <ul id="links">
                <li><a class="pointer" href="https://github.com/nekruz03/semester3/tree/main/Web/Lab2">Исходный код</a></li>
            </ul>
            </p>
        </td>
        <td id="area" width="20%">
    ...
    <tr>
        ...
        <td>
            <button onclick="cleanTable()" type="clean_button" id="clear" style="position: absolute">Очистить</button>
        </td>
    </tr>
